...
/* package simpleFuctions-0.1.0.0 */
#ifndef VERSION_simpleFuctions
#define VERSION_simpleFuctions "0.1.0.0"
#endif /* VERSION_simpleFuctions */
#ifndef MIN_VERSION_simpleFuctions
#define MIN_VERSION_simpleFuctions(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_simpleFuctions */
...
#define CURRENT_COMPONENT_ID "simpleFuctions-0.1.0.0-65gVC5qAvtz9ruHY40uMg0-simpleFuctions"
