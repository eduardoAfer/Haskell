...
/* package preciosismos-0.1.0.0 */
#ifndef VERSION_preciosismos
#define VERSION_preciosismos "0.1.0.0"
#endif /* VERSION_preciosismos */
#ifndef MIN_VERSION_preciosismos
#define MIN_VERSION_preciosismos(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_preciosismos */
...
#define CURRENT_COMPONENT_ID "preciosismos-0.1.0.0-InUVPtjUYg0HFahG9NZDwb-preciosismos"
